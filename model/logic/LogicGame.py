    ...
    def start_game_window(background, background_color, window, timer, during_game=False):
        ...
        while True:
            ...
            if choice == 1 or choice == 2:
                ...
                ''' Creating Heroes'''
                heroes = Heroes()
                hero1 = Hero(x=5170, y=170, width=22, height=28, keys=settings[:4], type="hero1",
                             name_image="r1.png",side=False, power=1, lifes=3, super_hero=False,
                ...
                if choice == 2:
                    hero2 = Hero(x=270, y=170, width=22, height=28, keys=settings[4:], type="hero2",
                                 name_image=r"C:\Users\Павел\PycharmProjects\CourseWork\controller\mario\hero2.png",side=False, power=1, lifes=3, super_hero=False,
                                 time_flower_activity=0, time_mushroom_activity=0, left=False, right=False, up=False,
                                 on_ground=False, xvel=0, yvel=0, move_speed=4, jump_power=16, gravity=1,
                                 fire_ability=False, flower_ability=False)
                    heroes.append(hero2)
                ...
                generator = LevelGenerator(platform_width=32, platform_height=32,
                                           levels=[r"C:\Users\Павел\PycharmProjects\CourseWork\controller\levels\level1.txt",
                                                   r"C:\Users\Павел\PycharmProjects\CourseWork\controller\levels\level2.txt"],
        ...
        while True:
            ...
            if button:
                ...
                if choice == 3:
                    ...
                    if during_game:
                        del generator
                        # generator.number_level = 0
                        # print(generator.number_level,"exit")
