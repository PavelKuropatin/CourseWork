            ...
            for symbol in row:
                if symbol == "." or symbol == "#":
                    item = Ground(x=x, y=y, width=self.platform_width, height=self.platform_height,
                                  image='data/blocks/platform.jpg')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "4":
                    item = Ground(x=x, y=y, width=64, height=64, image='data/blocks/pipe_greensmall.png')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "5":
                    item = Ground(x=x, y=y, width=64, height=96, image='data/blocks/pipe_green.png')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "6":
                    item = Ground(x=x, y=y, width=64, height=128, image='data/blocks/pipe_greenbig.png')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "-":
                    item = SimpleBlock(x=x, y=y, width=self.platform_width, height=self.platform_height,
                                       image='data/blocks/block_2.png', image_damage='data/blocks/block_1.png', lifes=2)
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "f":
                    item = BonusBlock(x=x, y=y, width=self.platform_height, height=self.platform_height,
                                      images_existing=['data/blocks/bonus_block_active_1.png',
                                                       'data/blocks/bonus_block_active_2.png'],

                                      image_simple='data/blocks/bonus_block_simple.png', koef=20, activity=True,
                    ...
                    item = Slub(x=x, y=y, width=self.platform_height, height=self.platform_height,
                                images_existing=['data/enemies/simple_enemy/slub1.png',
                    ...
                    item = Bowser(x=x, y=y, width=48, height=48,
                                  images_existing=[['data/enemies/bowser/bowser1_left.png',
                                                    'data/enemies/bowser/bowser2_left.png'],
                                                   ['data/enemies/bowser/bowser1_right.png',
                                                    'data/enemies/bowser/bowser2_right.png']],
                    ...
                    item = Exit(x=x, y=y, width=96, height=192, image='data/blocks/castle_right.png')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "k":
                    item = Nature(x=x, y=y, width=96, height=192, image='data/blocks/castle_left.png')
                    nature.add(item)
                elif symbol == "E":
                    item = Exit(x=x, y=y-8, width=132, height=20, image='data/blocks/pipe_exit_2.png')
                    entities.add(item)
                    platforms.append(item)
                elif symbol == "e":
                    item = Ground(x=x, y=y+4, width=132, height=44, image='data/blocks/pipe_exit_1.png')
                    nature.add(item)
                elif symbol == "0":
                    item = Nature(x=x, y=y, width=64, height=48, image='data/blocks/cloud.png')
                    nature.add(item)
                elif symbol == "1":
                    item = Nature(x=x, y=y, width=128, height=32, image='data/blocks/bush-1.png')
                    nature.add(item)
                elif symbol == "2":
                    item = Nature(x=x, y=y, width=96, height=32, image='data/blocks/bush-2.png')
                    nature.add(item)
                elif symbol == "3":
                    item = Nature(x=x, y=y, width=64, height=32, image='data/blocks/bush-3.png')
                    nature.add(item)
